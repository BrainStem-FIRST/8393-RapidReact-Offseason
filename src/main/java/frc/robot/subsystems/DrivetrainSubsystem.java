 ...
 * import static frc.robot.Constants.*;
 * 
 * public class DrivetrainSubsystem extends SubsystemBase implements
 * AutoCloseable {
 * 
 ...
 * SwerveDriveOdometry(kinematics,
 * new Rotation2d(0));
 * 
 * // resets heading
 * public void zeroHeading() {
 ...
 * DrivetrainConstants.FRONT_LEFT_DRIVE_MOTOR_REVERSED);
 * frontRightModule.setDesiredState(desiredStates[1],
 * DrivetrainConstants.FRONT_RIGHT_DRIVE_MOTOR_REVERSED);
 * backLeftModule.setDesiredState(desiredStates[2],
 * DrivetrainConstants.BACK_LEFT_DRIVE_MOTOR_REVERSED);
 * backRightModule.setDesiredState(desiredStates[3],
 * DrivetrainConstants.BACK_RIGHT_DRIVE_MOTOR_REVERSED);
 * }
 * 
 ...
 * // We have to invert the angle of the NavX so that rotating the robot
 * // counter-clockwise makes the angle increase.
 * return Rotation2d.fromDegrees(navx.getYaw()); // IF DOESN'T WORK DO 180 -
 * navx.getYaw()
 * }
 * 
 ...
 * }
 * 
 * /*private final SwerveModuleSubsystem frontLeftModule = new
 ...
 * DrivetrainConstants.FRONT_LEFT_TURNING_ABSOLUTE_ENCODER_REVERSED);
 * 
 * private final SwerveModuleSubsystem frontRightModule = new
 * SwerveModuleSubsystem(
 * DrivetrainConstants.FRONT_RIGHT_MODULE_DRIVE_MOTOR,
 * DrivetrainConstants.FRONT_RIGHT_MODULE_TURNING_MOTOR,
 ...
 * DrivetrainConstants.FRONT_RIGHT_TURNING_ABSOLUTE_ENCODER_REVERSED);
 * 
 * private final SwerveModuleSubsystem backLeftModule = new
 * SwerveModuleSubsystem(
 * DrivetrainConstants.BACK_LEFT_MODULE_DRIVE_MOTOR,
 * DrivetrainConstants.BACK_LEFT_MODULE_TURNING_MOTOR,
 ...
 * DrivetrainConstants.BACK_LEFT_TURNING_ABSOLUTE_ENCODER_REVERSED);
 * 
 * private final SwerveModuleSubsystem backRightModule = new
 * SwerveModuleSubsystem(
 * DrivetrainConstants.BACK_RIGHT_MODULE_DRIVE_MOTOR,
 * DrivetrainConstants.BACK_RIGHT_MODULE_TURNING_MOTOR,
 ...
 * @Override
 * public void periodic() {
 * odometer.update(getRotation2d(), frontLeftModule.getState(),
